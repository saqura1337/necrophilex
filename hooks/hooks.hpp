...
namespace hooks
{
	...
	extern int players_esp;
	extern int players_chams;
	...
	bool _fastcall send_net_message(void* ecx, void* edx, INetMessage* msg, bool reliable, bool voice);
	...
	inline sendnetmsg_fn original_sendnetmsg;
}
